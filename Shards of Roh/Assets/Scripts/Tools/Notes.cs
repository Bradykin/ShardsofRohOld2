...
//Selection Box
	//Idea 1: When selecting units + buildings, select the group that has more objects in the box, not the units
	//Idea 2: Add a toggle that makes selection prioritize buildings over units
